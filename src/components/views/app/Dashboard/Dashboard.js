  ...
  const cardsInfo = [
    {
      ...
      bgColor: "#f03a3a",
      totalCount: 10,
      icon: "bx bxs-id-card bx-lg",
    },
    {
      title: "Total DID",
      bgColor: "#408de6",
      totalCount: 10,
      icon: "bx bxs-user-rectangle bx-lg",
    },
    {
      title: "Messages",
      bgColor: "#4ce67a",
      totalCount: totalMsgCount,
      icon: "bx bx-message bx-lg",
    },
    {
      title: "Alerts",
      bgColor: "#f59d18",
      totalCount: 0,
      icon: "bx bxs-bell bx-lg",
    },
  ];

  useEffect(() => {
    const loadMessages = async () => {
      const res = await onApiCall("get", "user/loadMessagesForInbox", null, {
        userId: usrCtx?.userInfo?.userId,
      });
